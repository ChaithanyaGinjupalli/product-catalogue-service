...
/**
 * Covers the test cases related to BUY_THREE_FOR_TWO_PRICE
 */
class BuyThreeForTwoPriceCalculatorTest {
    ...
    private static Stream<Arguments> productQuantitySource() {
        return Stream.of(Arguments.of(null, null, BigDecimal.ZERO),
                ...
                Arguments.of(new BigDecimal("10.00"), 4L, new BigDecimal("30.00")),
                Arguments.of(new BigDecimal("10.00"), 6L, new BigDecimal("40.00")),
                Arguments.of(new BigDecimal("10.00"), 7L, new BigDecimal("50.00")));
    }
}